...
import 'package:vedanta_lrms/presentation/add_new_survey_screen/models/add_new_card_model.dart';
...
class AddNewCardController extends GetxController {
  ...
  onSelected(dynamic value) {
    ...
    addNewCardModelObj.value.dropdownItemList.forEach((element) {
  ...
  onSelected1(dynamic value) {
    ...
    addNewCardModelObj.value.dropdownItemList1.forEach((element) {
      element.isSelected = false;
      if (element.id == value.id) {
        element.isSelected = true;
      }
    });
    addNewCardModelObj.value.dropdownItemList1.refresh();
  }
}
