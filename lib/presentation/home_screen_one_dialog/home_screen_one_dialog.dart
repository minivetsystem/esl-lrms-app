import '../home_screen_one_dialog/widgets/listw_item_widget.dart';
...
class HomeScreenOneDialog extends StatelessWidget {
  HomeScreenOneDialog(this.controller);
            ...
            child: Row(
              ...
              children: [
                CustomDropDown(
                  ...
                  items:
                      controller.homeScreenOneModelObj.value.dropdownItemList,
                  onChanged: (value) {
                ...
                CustomDropDown(
                  ...
                  items:
                      controller.homeScreenOneModelObj.value.dropdownItemList1,
                  onChanged: (value) {
                        ...
                        Container(
                          ...
                          child: Obx(
                            () => ListView.separated(
                              ...
                              itemCount: controller.homeScreenOneModelObj.value
                                  .listwItemList.length,
                              itemBuilder: (context, index) {
                                ListwItemModel model = controller
                                    .homeScreenOneModelObj
                                    .value
                                    .listwItemList[index];
                                return ListwItemWidget(
                                  model,
                                );
                              },
                            ),
