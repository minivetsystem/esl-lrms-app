import '../home_six_dialog/widgets/home_six_item_widget.dart';
...
class HomeSixDialog extends StatelessWidget {
  HomeSixDialog(this.controller);

  HomeSixController controller;
            ...
            child: Row(
              ...
              children: [
                CustomDropDown(
                  ...
                  items: controller.homeSixModelObj.value.dropdownItemList,
                  onChanged: (value) {
                ...
                CustomDropDown(
                  ...
                  items: controller.homeSixModelObj.value.dropdownItemList1,
                  onChanged: (value) {
                          ...
                          child: Obx(
                            () => ListView.separated(
                              ...
                              itemCount: controller
                                  .homeSixModelObj.value.homeSixItemList.length,
                              itemBuilder: (context, index) {
                                HomeSixItemModel model = controller
                                    .homeSixModelObj
                                    .value
                                    .homeSixItemList[index];
